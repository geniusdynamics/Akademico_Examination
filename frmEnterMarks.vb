...
Public Class frmEnterMarks
    ...
    Private Sub import_data()
        ...
        End While
        progressBarLC.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        progressBarLC.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Always
        save_now()
    End Sub
    Dim total As Double
    ...
    Private Sub btnImportResults_Click(sender As Object, e As EventArgs) Handles btnImportResults.Click
        ...
        For rCnt = 1 To range.Rows.Count
            ...
            dgvEnterMarks.Rows(rCnt - 1).Cells(abbr).Value = Obj.value

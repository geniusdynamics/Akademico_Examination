...
Public Class frmMeanResults
    ...
    Private Function getWhereStatements() As String
        Dim where As String = String.Empty

        For i = 0 To examList.Count - 1
            where += " (examination = '" + examList(i).Item1 + "' and term = '" + examList(i).Item2 + "' and year = " + examList(i).Item3 + " ) or "
        Next
    ...
    Private Function convertGradeToPointsReverse(ByVal grade As Integer) As String
    ...
    Private Function getHighestMark(ByVal subjectList As Array, ByVal rowIndex As Integer) As List(Of Tuple(Of String, Integer))
        ...
        For Each s As String In subjectList
            subjectMarkss.Add(New Tuple(Of String, Integer)(s, dgvMeanMarks.Rows(rowIndex).Cells(s).Value))
        Next
        ...
        If confirm("Are You Sure ?") Then
            ...
            Using New DevExpress.Utils.WaitDialogForm("Saving Data Please Wait")
                For i = 0 To dgvMeanMarks.Rows.Count - 1
                    index = code + dgvMeanMarks.Rows(i).Cells("OP").Value
                    If Not qwrite("UPDATE students SET indexno = '" & index & "' WHERE admin_no =  '" & dgvMeanMarks.Rows(i).Cells("admno").Value & "'") Then
                        rollback()
    ...
    Private Sub frmMeanResults_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If Not connect() Then
            Me.Close()
        Else
            Using New DevExpress.Utils.WaitDialogForm("Please Wait ...")
                ...
                Dim whereStatement As String = getWhereStatements()
                ...
                For i = 0 To students.Count - 1
                    ...
                    If qread(sqlStatment) Then
                        If dbreader.RecordsAffected > 0 Then
                            ...
                            ElseIf sortGradesBy = "Mean Marks" Then
                                allResults.Add(New Tuple(Of String, Double)(students(i).Item5, Math.Round(tmm / subjectEntries, 2, MidpointRounding.AwayFromZero)))
                            ElseIf sortGradesBy = "Mean Points" Then
    ...
    Private Function getSmallest(ByVal parm1 As Integer, ByVal parm2 As Integer)
    ...
    Private Sub marksGrade_CheckedChanged(sender As Object, e As EventArgs) Handles marksGrade.CheckedChanged
        If marksGrade.CheckState = CheckState.Checked Then
            showMarksAndGrade()
        Else
            deleteMarkGrade()
        End If
    ...
    Private Sub save_examination()
        ...
        For k = 0 To examList.Count - 1
            exam_name += examList(k).Item1 + "/"
        Next
